...
double ee1, ee2, ee4, ee5, ee6, ee7, ee8, ee9, ee10; 
double ee11, ee12, ee14, ee15, ee16, ee19; 
double ee22, ee25; 
...
out(j, 3) = w * xi * ee7/(ee10 * ee1 * ee1);
out(j, 4) = w * (ee25 - ee16)/ee1;
out(j, 5) = ee22/ee1;
out(j, 6) = -(w * (ee16 - ee25) * ee2/ee1);
out(j, 7) = ee22 * ee2/ee1;
out(j, 8) = w * (((ee2/(ee6 * ee1) - 
            2 * (ee9/xi))/ee15 + ee9 * ee19/xi)/xi + (ee14 + 
            (ee16 - ee9/(xi * ee8))/xi) * ee2/ee1)/xi;
...
ee49 = 2/ee13;
ee50 = 2/xi;
ee52 = (ee22/ee10 + ee8 * ee24)/ee11 + (1/ee28 - ee7 * ee40) * 
  ee2/ee1;
...
ee75 = ee61 * ee8;
ee78 = (((2 * (ee8/(xi * ee10)) - ee36)/xi - ee58)/ee11 - 
  ee52 * ee9) * ee2/ee1;
ee80 = (ee22/ee32 + ee8 * ee60/xi)/xi + (ee26 + (ee48 - 
  ee63)/xi) * ee2/ee1;
ee81 = ee55/ee14;
ee86 = 4/ee10;
ee87 = 4/ee13;
...
ee95 = ((ee80 * ee8 + 2 * (ee22 * ee60))/xi - ee55/ee32)/xi + 
 ((((ee26 + (2/ee14 - ee63)/xi) * ee8 - (ee34 + 2/ee14))/xi - 
 2 * ee26)/xi - ee46) * ee2/ee1;
...
ee120 = ee64 * (ee70 + ee86 - ee43 * (ee49 + ee87 - ee74) * 
  ee2/ee1) * ee2/ee1;
...
double ee11, ee12, ee14, ee16, ee17; 
...
out(j, 3) = -(ee10 * ee8/(ee5 * ee5 * ee1 * ee1));
...
ee36 = R_pow(ee1, 3);
ee37 = ee25 - 1;
ee40 = (((2 * ee5 - ee27)/ee5 + 4) * ee7 * ee2/ee6 + ee13/ee10) * 
  ee2/ee6 + ((4 * ee20 - 6)/xi + 2 * ee30 + 2 * ee13 * 
  ee2/ee6)/ee10;
...
out(j, 9) = (ee55 * 
            ee2/ee6 + (ee15 - 6 * ee59)/xi)/ee10 + (ee55/ee10 + 
...
out(j, 14) = (xi * (ee7 * (4 - xi * (ee31 + 4) * ee2/ee6) + ee15) - 2)/ee29;
out(j, 15) = -((ee7 * (2 - xi * (ee32 + 4) * ee2/ee6) + 4 * ee2 - ee13/xi)/ee6/ee6);
...
out(j, 19) = -(ee40/ee6);
out(j, 20) = -(ee22 * (xi * (7 + xi * (ee33 - 6) * ee2/ee6) * ee2/ee6 - 1) * ee2/ee6);
out(j, 21) = -((ee7 * (1 + xi * (ee62 - 7) * ee2/ee6) - ee56/xi) * ee2/ee6);
out(j, 22) = -((ee45 - (ee57 - (2 + 2 * ee63))/ee10) * ee2/ee6);
out(j, 23) = -(ee40 * ee2/ee6);
out(j, 24) = (((24 * ee59 - 6 * ee11)/xi - ee35 * ee2/ee6)/xi - ee53 * 
            ee2/ee6)/ee10 - (ee53/ee10 + (ee34/ee10 + (2/ee10 + 
